...
public class NewJFrame extends javax.swing.JFrame {
    ...
    private void atsakymasButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_atsakymasButtonActionPerformed
        ...
        onVisibleAtsakymai();
        Kreditai naujasSkaiciavimas = new Kreditai();
        naujasSkaiciavimas.setPaskolosSuma(Integer.parseInt(paskolosSumaTextField.getText()));
    ...
    private void atsakymas2ButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_atsakymas2ButtonActionPerformed
        ...
        naujasAtsakymas.setPaskolosSuma(Integer.parseInt(paskolosSumaTextField.getText()));

        naujasAtsakymas.setPaskolosSuma(Integer.parseInt(paskolosSumaTextField.getText()));
        naujasAtsakymas.setLaikotarpis(Integer.parseInt(laikotarpisTextField.getText()));

        naujasAtsakymas.setSeimosPajamosAtskaiciusMokescius(Integer.parseInt(seimosPajamosAtskaiciusMokesciusTextField.getText()));
